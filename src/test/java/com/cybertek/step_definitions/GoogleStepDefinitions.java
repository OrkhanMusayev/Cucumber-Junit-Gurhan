...
public class GoogleStepDefinitions {
    ...
    public void user_is_on_the_google_search_page() {
        ...
        Driver.getDriver_Method().get("https://www.google.com");
    ...
    public void user_should_see_title_is_google() {
        ...
        String actualTitle = Driver.getDriver_Method().getTitle();
    ...
    public void user_should_see_six_links_in_the_footer(List<String> listStrings) {

        int expectedSize = listStrings.size();
